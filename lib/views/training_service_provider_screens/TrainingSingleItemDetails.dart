...
class _TrainingSingleItemDetailsState extends State<TrainingSingleItemDetails> {
  ...
  void initState() {
   WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
     ...
     jobProvider.getVewSingleTraining(widget.viewAllTrainingsData.id!).then((value) {
     ...
     print("sdfsdf  ${widget.viewAllTrainingsData.id!}");
                                      ...
                                      applyButtonShow ?   CustomSearchButton( AppConstants.Apply, () {
                                       ...
                                       trainingsProvider.singleTraningModel?.isApplied == true ? null :  trainingsProvider.applayTraining(trainingsProvider.singleTraningData!.id!).then((value){
                                          if(value.isSuccess){
                                            ...
                                            Provider.of<TrainingsProvider>(context,listen: false).getVewSingleTraining(widget.viewAllTrainingsData.id!);
