...
class LatestJobDetailScreen extends StatefulWidget {
  LatestJobModel viewAllJobDataF;
  LatestJobDetailScreen(this.viewAllJobDataF);

  @override
  State<LatestJobDetailScreen> createState() =>
      _LatestJobDetailScreenState();
}

class _LatestJobDetailScreenState extends State<LatestJobDetailScreen> {
